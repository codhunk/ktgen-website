...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed z-50 top-0 flex justify-center items-center text-sm font-semibold">
      <div className="w-[95%] 2xl:max-w-6xl flex justify-between items-center py-4">
        ...
        <ul className="flex justify-center items-center gap-10">
          ...
          <div className="flex justify-center items-center gap-2">
            ...
            `}
                ...
                {n.subLink && (
                  <ul
                    className={`absolute top-full mt-0.5 right-0 w-40 bg-[#005c633b] backdrop-blur-md rounded-lg shadow-lg z-20 transform transition-all duration-300 ease-in-out ${activeDropdown === i
        ...
        <ul className="flex justify-center items-center gap-4 text-white">
          ...
          <li className="p-2 border border-dashed rounded-full border-slate-200 bg-slate-950 relative cursor-pointer">
            ...
            <div
              className={`absolute top-full right-0 mt-2 w-36 bg-[#005c633b] backdrop-blur-md rounded-lg shadow-lg z-20 transform transition-all duration-300 ease-in-out ${open
                  ? "opacity-100 translate-y-0 pointer-events-auto"
                  : "opacity-0 -translate-y-2 pointer-events-none"
                }`}
            >
