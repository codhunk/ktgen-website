        ...
        <div className="h-full md:min-h-screen relative overflow-hidden dark:bg-gray-900 w-full sm:w-[800px] md:w-[900px] lg:w-[1200px] max-w-7xl">
            ...
            <div className="relative z-10 container mx-auto h-[60vh] md:min-h-screen py-8 sm:py-16 px-1 sm:px-8">
                <div className="absolute top-2 left-2 sm:top-4 sm:left-4">
                    <StatCard target={500} suffix="+" title="Trust Brand" delay={0.2} icon={Shield} />
                </div>

                <div className="absolute top-2 right-2 sm:top-4 sm:right-4">
                    <StatCard target={1200} suffix="+" title="Partner Pharmacies" delay={0.4} icon={Building2} />
                </div>

                <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4">
                    <StatCard target={250} suffix="+" title="Towns and Villages" delay={0.6} icon={MapPin} />
                </div>

                <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4">
                    <StatCard target={99} suffix="%" title="Timely Delivery Rate" delay={0.8} icon={Clock} />
                </div>
