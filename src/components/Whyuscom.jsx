...
function Whyuscom() {
    return (
        <div className=' bg-white h-auto overflow-y-scroll rounded-3xl flex  justify-center sm:overflow-x-scroll mb-10'>
            <div className=' flex justify-center items-center h-[1260px] w-[320px] '>
                <div className='h-[84%] w-[46%] relative bg-yellow-500'>
                    ...
                    <div className=' flex absolute -left-[50px] top-[202px]'>
                        <div className='w-[135px] h-[135px] rounded-full bg-white'>
                            <div className='relative -left-[160px] top-3 w-[290px] flex flex-col items-center'>
                                <h1 className='font-semibold text-black'>Nature Meets Science</h1>
                                <p className='text-sm text-gray-600 text-center leading-5'>
