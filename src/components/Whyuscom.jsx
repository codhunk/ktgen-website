...
function Whyuscom() {
    return (
        <div className='border-b border-b-2 border-b-gray-600 h-screen rounded-tr-3xl rounded-tl-3xl overflow-y-scroll flex mb-6 justify-center '>
            <div className=' flex justify-center items-center h-[1260px] w-[320px]'>
                <div className='h-[84%] w-[46%] relative bg-yellow-500'>
                    <div className=' flex absolute -left-[50px] -top-[60px]'>
                        ...
                        <div className=' w-[135px] h-[135px] p-3 rounded-full bg-yellow-500'>
                            <div className='bg-white dark:bg-gray-900 h-full rounded-full flex items-center justify-center shadow-[5px_5px_15px_black]'><Target className="w-[50px] h-[50px] text-yellow-500" /></div>
                        </div>
                    </div>
                    ...
                    <div className=' flex absolute -left-[50px] top-[202px]'>
                        ...
                        <div className=' w-[135px] h-[135px] p-3 rounded-full bg-yellow-500'><div className=' bg-white dark:bg-gray-900 h-full rounded-full flex items-center justify-center shadow-[5px_5px_15px_black]'><Leaf className="w-[50px] h-[50px] text-yellow-500" /></div></div>
                    </div>
                    ...
                    <div className=' flex absolute -left-[50px] top-[464px]'>
                        ...
                        <div className=' w-[135px] h-[135px] p-3 rounded-full bg-yellow-500'><div className=' bg-white dark:bg-gray-900 h-full rounded-full flex items-center justify-center shadow-[5px_5px_15px_black]'><Heart className="w-[50px] h-[50px] text-yellow-500" /></div></div>
                    </div>
                    ...
                    <div className=' flex absolute -left-[50px] top-[726px]'>
                        ...
                        <div className=' w-[135px] h-[135px] p-3 rounded-full bg-yellow-500'><div className='bg-white dark:bg-gray-900 h-full rounded-full flex items-center justify-center shadow-[5px_5px_15px_black]'><User className="w-[50px] h-[50px] text-yellow-500" /></div></div>
                    </div>
                    ...
                    <div className=' flex absolute -left-[50px] top-[988px]'>
                        ...
                        <div className=' w-[135px] h-[135px] p-3 rounded-full bg-yellow-500'><div className=' bg-white dark:bg-gray-900 h-full rounded-full flex items-center justify-center shadow-[5px_5px_15px_black]'><Handshake className="w-[50px] h-[50px] text-yellow-500" /></div></div>
                    </div>
                </div>
            </div>
