  ...
  const features = [
    {
      ...
      description:
        "Tailored treatments based on your unique health profile and goals.",
    },
    {
      icon: <IoIosHeart className="text-2xl text-blue-600" />,
      title: "Compassionate Care",
      description:
        "Understanding and discreet approach to sensitive men’s health issues.",
    },
    {
      icon: <RiBrainLine className="text-2xl text-blue-600" />,
      title: "Expert Knowledge",
      description:
        "Board-certified specialists with decades of men’s health experience.",
    },
    {
      icon: <TbTrophy className="text-2xl text-green-400" />,
      title: "Proven Results",
      description:
        "98% patient satisfaction rate with measurable health improvements.",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              At ManMed Health, we understand that men's health goes beyond
              treating symptoms. We focus on empowering you with comprehensive
              solutions that restore your vitality, confidence, and peak
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Your privacy is our priority with HIPAA-compliant
