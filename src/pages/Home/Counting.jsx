...
const AnimatedCounter = ({ value, duration = 5000, suffix = "", prefix = "" }) => {
...
const StatCard = ({ icon: Icon, value, suffix, prefix, label, delay, showValue }) => {
    return (
        <motion.div
    ...
    return (
        <section className="py-12 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
                ...
                <div className="absolute bottom-20 right-10 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
            </div>
