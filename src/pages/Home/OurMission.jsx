            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            We're not just a pharma company — we're your partner in better healthcare.
                            Our mission is to make high-quality generics accessible, while building trust
                            through brand clarity, ethical sourcing, and field-first strategies.
                        </motion.p>
                        ...
                        <div className="relative bg-gradient-to-br from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-3xl overflow-hidden shadow-2xl">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-sm font-semibold text-gray-900 dark:text-white">Quality Assured</div>
                                        <div className="text-xs text-gray-500 dark:text-gray-400">WHO-GMP Certified</div>
                                    </div>
                                </div>
                            </motion.div>
