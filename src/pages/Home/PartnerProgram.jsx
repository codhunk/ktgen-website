...
const PartnerProgram = () => {
    ...
    const features = [
        {
            ...
            description: "Every scan converts to valuable reward points automatically",
    ...
    const stats = [
        { number: "50K+", label: "Active Pharmacies", icon: <TrendingUp className="w-6 h-6" /> },
        { number: "2M+", label: "Points Earned", icon: <Star className="w-6 h-6" /> },
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-20 lg:py-32">
                    ...
                    >
                        ...
                        >
                            Transform your pharmacy business with our intelligent reward system.
                            Earn points, gain recognition, and unlock exclusive benefits designed for sustainable growth.
                        </motion.p>
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                            Everything you need to maximize your pharmacy's potential and drive sustainable growth
                        </p>
                    </motion.div>
                ...
                <div className="container mx-auto px-6 text-center relative">
                    ...
                    >
                        ...
                        <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                            Join thousands of pharmacies already growing with our reward system
                        </p>
