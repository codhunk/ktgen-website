...
const Pregnency_sec = () => {
  ...
  return (
    ...
    <div className="pb-10 pt-10 sm:pt-2 px-3 sm:px-6 max-w-5xl mx-auto space-y-10">
      {/* Banner */}
      <div style={{backgroundImage:"url('/images/baby.jpg')"}} className="bg-cover shadow-lg dark:shadow-none shadow-gray-500 text-gray-800 dark:text-[#57564F] bg-center bg-gray-200 p-8 md:p-20 rounded-xl text-center">
        <h1 className="text-4xl font-bold">{t("pregnency_j")}</h1>
        <p className="mt-2 text-lg font-semibold">{t("preg_explore")}</p>
      </div>

      {/* About */}
      <div className="bg-white dark:bg-gray-800 bg-opacity-[50%] [#7A7A73] dark:shadow-none dark:text-white text-gray-700  p-6 rounded-xl shadow-md shadow-gray-500">
        <h2 className="text-2xl font-semibold mb-3">{t("preg_about")}</h2>
        <p className="font-semibold">{t("preg_h")}</p>
      </div>

      {/* Video Playlist */}
      <div className="bg-gray-100 dark:bg-[#7A7A73] dark:shadow-none py-6 px-4 sm:px-6 rounded-xl shadow-md shadow-gray-500">
